...
The data profiling step helped provide the data in an easily readable form, identify the presence of null values for each feature and their predominance over the total entries.\\
...
Feature importance was also calculated to see if all of the features selected were relevant in the modelling of the algorithm and evaluate discarding the one below a specific percentage.\\
