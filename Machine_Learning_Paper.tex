...
The data profiling phase helped evaluate the presence of null values for each feature and their predominance over the total entries.\\
...
However, applying it to all six features increased the amount of features to 51 (with an increase of 30 from the original 21, more than doubling it). This amount will, however, be later reduced to simplify computations and save resourses.\\
